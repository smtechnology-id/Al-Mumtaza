                    ...
                    <div class="card-body">
                        <div class="panel">
                            <div class="timeline-box">
                                ...
                                <h4 class="fs-16 fw-semibold ">{{ $detail->student->nama_lengkap }} - <span
                        ...
                        @if ($detail->status_report == 'pending')
                            <a href="{{ route('changeStatus', ['id' => $detail->id, 'status' => 'approved']) }}"
                                class="btn btn-primary btn-sm" btn-sm>Setujui</a>
                            <a href="{{ route('changeStatus', ['id' => $detail->id, 'status' => 'rejected']) }}"
                                ...
                                <article class="timeline-item alt">
                                    <div class="text-start">
                                        <div class="time-show first">
                                            <a href="#" class="btn btn-primary w-lg">Riwayat Pelanggaran Siswa</a>
                                        </div>
                                    </div>
                                </article>
