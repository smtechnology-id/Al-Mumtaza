        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('teacherInput') }}" class="btn btn-primary"><i class="bi bi-plus-circle-fill"></i>
                        Tambah Guru</a>
                    <p class="text-muted mb-0">
                        Berikut Adalah Data Guru Di Pondok Pesantren Mumtaza
                    </p>
                </div>
                <div class="card-body">
                    @if (session('success'))
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#danger-alert-modal{{ $data->id }}"><i
                                                class="bi bi-trash"></i></button>
                                        <div id="danger-alert-modal{{ $data->id }}" class="modal fade" tabindex="-1"
                                                ...
                                                <div class="modal-content modal-filled bg-danger">
                                                    <div class="modal-body p-4">
                                                        <div class="text-center">
                                                            ...
                                                            <a href="{{ route('teacherDelete', ['id' => $data->id]) }}"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <!-- Tambahkan kode HTML untuk menampilkan data guru di sini -->
