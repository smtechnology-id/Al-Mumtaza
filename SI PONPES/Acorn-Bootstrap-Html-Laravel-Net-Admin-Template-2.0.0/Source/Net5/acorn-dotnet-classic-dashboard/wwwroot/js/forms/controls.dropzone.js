    ...
    if (document.querySelector('#dropzoneServerFiles')) {
      new Dropzone('#dropzoneServerFiles', {
        ...
        init: function () {
          ...
          this.displayExistingFile(mockFile1, Helpers.UrlFix('/img/product/small/product-1.webp'));
          ...
          this.displayExistingFile(mockFile2, Helpers.UrlFix('/img/product/small/product-2.webp'));
