    ...
    if (document.getElementById('dropzoneProductImage')) {
      new Dropzone('#dropzoneProductImage', {
        ...
        init: function () {
          ...
          this.displayExistingFile(mockFile1,  Helpers.UrlFix('/img/product/small/product-3.webp'));
    ...
    if (document.getElementById('dropzoneProductGallery')) {
      new Dropzone('#dropzoneProductGallery', {
        ...
        init: function () {
          ...
          this.displayExistingFile(mockFile1,  Helpers.UrlFix('/img/product/small/product-10.webp'));

          let mockFile2 = {name: 'bread.webp', size: 267140};
          this.displayExistingFile(mockFile2,  Helpers.UrlFix('/img/product/small/product-4.webp'));

          let mockFile3 = {name: 'cupcake.webp', size: 267140};
          this.displayExistingFile(mockFile3,  Helpers.UrlFix('/img/product/small/product-1.webp'));

          let mockFile4 = {name: 'pastry.webp', size: 267140};
          this.displayExistingFile(mockFile4,  Helpers.UrlFix('/img/product/small/product-7.webp'));
